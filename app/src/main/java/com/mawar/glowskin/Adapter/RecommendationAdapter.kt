...
import com.mawar.glowskin.Activity.DetailActivity
import com.mawar.glowskin.Model.ItemsModel
import com.mawar.glowskin.databinding.ViewholderRecommendBinding

class RecommendationAdapter(val items: List<ItemsModel>) : RecyclerView.Adapter<RecommendationAdapter.ViewHolder>() {
